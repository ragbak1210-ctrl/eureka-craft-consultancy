  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Eureka Craft helps founders build clarity, narrative, and growth through strategic brand consulting and digital storytelling." />
      </Head>
        ...
        <div className="container-wide">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl">
              Eureka Craft helps founders and leadership teams build clarity, narrative, and structured visibility through consulting-led brand strategy.
            </p>
      ...
      <section className="section-spacing bg-gray-50">
        <div className="container-wide">
          <h2 className="text-4xl md:text-5xl font-bold mb-12">Why Most Marketing Doesn't Work</h2>
          
          <div className="max-w-3xl">
            <p className="text-lg text-gray-600 mb-6">
              Despite strong products and capable teams, many businesses struggle to translate expertise into a clear narrative.
            </p>
      ...
      <section className="section-spacing bg-white">
        <div className="container-wide">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">Stop Auditing. Start Aligning.</h2>
          
          <div className="max-w-3xl space-y-6">
            <p className="text-lg text-gray-600">
              Eureka Craft is a clarity-first consulting studio that aligns brand positioning, messaging, and narrative before execution begins.
            </p>

            <p className="text-lg text-gray-600">
              Our work begins with <strong>The Clarity X-Ray™</strong> — a proprietary blindspot audit that identifies where brands silently lose trust and impact.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-spacing bg-gray-50">
        <div className="container-wide">
          <h2 className="text-4xl md:text-5xl font-bold mb-16">Consulting Areas</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              ...
              <div key={index} className="border border-gray-300 p-8 rounded">
      ...
      <section className="section-spacing bg-white">
        <div className="container-wide">
          <div className="max-w-3xl mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">The Clarity X-Ray™</h2>
      ...
      <section className="section-spacing bg-gray-50">
        <div className="container-wide">
          <h2 className="text-4xl md:text-5xl font-bold mb-12">Who We Work With</h2>
